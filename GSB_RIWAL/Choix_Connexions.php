...
if (gettype($statut_C) == "array" ){
    ...
    echo "<html>
            ...
            <body>  
                <fieldset>
                    <input type='button' name='lien0' value='Retour en arriere' onclick='self.location.href='GSB_Connexions.ph' style='background-color:#658db3' style='color:white; font-weight:bold'onclick>
                    <br/>

...
<html>
    ...
    <body>  
        ...
        <fieldset>
            <br/>
            <input type="button" name="lien1" value="Remboursement des frais" onclick="self.location.href='GF6/GF6.php?idFicheFrais=0&choix=nothing'" style="background-color:#3cb371" style="color:white; font-weight:bold"onclick>
            <br/><br/>

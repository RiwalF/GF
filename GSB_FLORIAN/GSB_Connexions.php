    ...
    <form name="GF4/GF4.php" action="Choix_Connexions.php" method="get">
        <fieldset class="orange">
            ...
            <label for="mdp" class="titre2">Mot de passe :</label>
                <input type="password" id="mdp" name="mdp" placeholder="**********" class="my-text-input" /></br>

            <label for="immat" class="titre2">Immatriculation :</label>
                <input type="text" id="immat" name="immat" placeholder="AA-000-AA" class="my-text-input" /></br>
